        ...
        <?php if ($total_pages > 1): ?>
            ...
            <div class="pagination"
                ...
                <div style="font-size: 0.875rem; color: #64748b;">
                    ...
                    <?php echo min($offset + $items_per_page, $total_categories); ?> of
    ...
    <?php else: ?>
        <div class="card" style="text-align: center; padding: 3rem;">
            ...
            <?php else: ?>
                ...
                <p style="color: var(--secondary); margin-bottom: 1.5rem;">Get started by creating your first product category.
                </p>
