...
// Get Footer ID and Content
$pageId = $_GET['id'] ?? null;
$pageData = [];
$pageTitle = 'Untitled Footer';
$pageSlug = '';
...
<head>
    ...
    <title>Footer Builder - <?php echo htmlspecialchars($pageTitle); ?></title>
    <script>
        ...
        const BUILDER_TYPE = 'footer';
        const API_URL = "api/save-footer.php";
...
<body>
    ...
    <script>
        ...
        // Preview button handler for footer
        $('#btn-preview').on('click', function () {
            // For footer preview, we need to show a page with this footer applied
            // We'll create a temporary preview URL that applies this footer
            const previewUrl = `../preview-footer.php?footer_id=${PAGE_ID}`;
