...
// Get Header ID and Content
$pageId = $_GET['id'] ?? null;
$pageData = [];
$pageTitle = 'Untitled Header';
$pageSlug = '';
...
if ($pageId) {
    ...
    // For now, let's keep it as is (demo mode or error)
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Header Builder - <?php echo htmlspecialchars($pageTitle); ?></title>
    <script>
        ...
        const BUILDER_TYPE = 'header';
        const API_URL = "api/save-header.php"; // Assuming this might be different, keeping original if matches
...
<body>
    ...
    <script>
        ...
        // Preview button handler for header
        $('#btn-preview').on('click', function () {
            // For header preview, we need to show a page with this header applied
            const previewUrl = `../preview-header.php?header_id=${PAGE_ID}`;
