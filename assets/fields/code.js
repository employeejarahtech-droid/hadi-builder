class CODE {
    constructor(id, label, value, placeholder) {
        this.id = id;
        this.randid = `code_${Math.random().toString(36).substr(2, 9)}`; // Generate a unique random ID
        this.label = label || 'Code'; // Default label if not provided
