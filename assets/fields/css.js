class CSS {
    constructor(id, label, value, placeholder) {
        this.id = id;
        this.randid = `css_${Math.random().toString(36).substr(2, 9)}`; // Generate a unique random ID
        this.label = label || 'CSS'; // Default label if not provided
...
//     const args = ['textAreaId', { label: 'Your Message' }, 'Default text here.'];
//     const selectorDiv = '#form-container'; // Change to your target container
//     CSS.init(args, selectorDiv);
// });
