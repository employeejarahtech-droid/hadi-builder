...
<div id="tabs_wrapper">
	<div id="tabs_container">
		<ul id="tabs">
			<li><a href="#tab1">Add / Edit new</a></li>
...
$(document).ready(function(){	
	...
	$("#tabs li").click(function() {
		...
		$("#tab1_content").html('<div style="text-align:center;font-size:14px;font-weight:bold;height:100px;"> Loading... </div>');
		/*$(".tab1_content").load("signup/signup.php",function(responseTxt,statusTxt,xhr){
			if(statusTxt=="success")
			 	scroolTo_f();
			if(statusTxt=="error")
			   	$(".main_data_others").text("Error: "+xhr.status+": "+xhr.statusText);
	  	});*/
		...
		maskPage();
		$(".tab1_content").load("settings/create_page/create_page.php",function(responseTxt,statusTxt,xhr){
			if(statusTxt=="success")
			 	maskPage();
			if(statusTxt=="error")
		...
		$("#tabs li:nth-child(2)").click(function() {
			...
			$(".tab2_content").load("settings/create_page/create_page_view.php",function(responseTxt,statusTxt,xhr){
				if(statusTxt=="success")
				 maskPage();
				if(statusTxt=="error")
				  $(".tab2_content").text("Error: "+xhr.status+": "+xhr.statusText);
			});
		...
		$("#tabs li:nth-child(3)").click(function() {
			...
			$(".tab3_content").load("settings/create_page/jquery.html",function(responseTxt,statusTxt,xhr){
				if(statusTxt=="success")
				 maskPage();
				if(statusTxt=="error")
				  $(".tab3_content").text("Error: "+xhr.status+": "+xhr.statusText);
			});
