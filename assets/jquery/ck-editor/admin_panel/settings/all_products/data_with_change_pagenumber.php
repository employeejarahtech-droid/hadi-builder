		...
		<div class="main_title_data">
			...
			<div id="right_data_p<?php echo $i; ?>" class="right_data">
				...
				<div class="message_body">
					<textarea name="textarea_short<?php echo $result2["id"];  ?>" class="textarea_short" id="textarea_short<?php echo $result2["id"];  ?>" cols=""   onchange="limitText(this,5250);" onkeyup="limitText(this,5250);"  onkeydown="limitText(this,5250);" rows=""  placeholder="<?php echo $short_p;  ?>"><?php echo str_replace("<br />", "\n", $result2["name"]); ?></textarea>	
	
				</div>
				<div class="message_body">
					<textarea name="textarea_color<?php echo $result2["id"];  ?>" class="textarea_short" id="textarea_color<?php echo $result2["id"];  ?>" cols=""  maxlength="50" onchange="limitText(this,5250);" onkeyup="limitText(this,5250);"  onkeydown="limitText(this,5250);" rows=""  placeholder="<?php echo $color_p;  ?>" ><?php echo str_replace("<br />", "\n", $result2["color"]); ?></textarea>	
	
				</div>
				<div class="message_body">
					<textarea name="textarea_size<?php echo $result2["id"];  ?>" class="textarea_short" id="textarea_size<?php echo $result2["id"];  ?>" cols=""  maxlength="50" onchange="limitText(this,5250);" onkeyup="limitText(this,5250);"  onkeydown="limitText(this,5250);" rows="" placeholder="<?php echo $size_p;  ?>" ><?php echo str_replace("<br />", "\n", $result2["size"]); ?></textarea>	
