...
?>
			...
			<div class="company_tittle"><input name="textfield_name<?php echo $id;  ?>" id="textfield_name<?php echo $id;  ?>" class="textfield_tittle" value="<?php echo $name;  ?>" type="text" placeholder="<?php echo $name_p;  ?>" /></div>
				...
				<div class="message_body">
					<textarea name="textarea_short<?php echo $id;  ?>" class="textarea_short" id="textarea_short<?php echo $id;  ?>" cols=""  maxlength="50" onchange="" onkeyup=""  onkeydown="" rows=""  placeholder="<?php echo $short_p;  ?>"><?php echo str_replace("<br />", "\n", $short); ?></textarea>	
	
				</div>
				<div class="message_body" style="display:none;">
					<textarea name="textarea_color<?php echo $id;  ?>" class="textarea_short" id="textarea_color<?php echo $id;  ?>" cols=""  maxlength="50" onchange="limitText(this,250);" onkeyup="limitText(this,250);"  onkeydown="limitText(this,250);" rows=""  placeholder="<?php echo $color_p;  ?>" ><?php echo str_replace("<br />", "\n", $color); ?></textarea>	
	
				</div>
				<div class="message_body" style="display:none;">
					<textarea name="textarea_size<?php echo $id;  ?>" class="textarea_short" id="textarea_size<?php echo $id;  ?>" cols=""  maxlength="50" onchange="limitText(this,250);" onkeyup="limitText(this,250);"  onkeydown="limitText(this,250);" rows="" placeholder="<?php echo $size_p;  ?>" ><?php echo str_replace("<br />", "\n", $size ); ?></textarea>	
