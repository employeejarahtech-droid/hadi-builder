...
<div id="Addnew">
	...
	<div id="header_text">Edit selected Language</div>
	
	<div id="clear"></div>

	<div id="field_content">
		<div id="tittle">Name</div>
		<div id="field"><input name="id" id="id" type="hidden" value="<?php echo $row['id']; ?>" /><input class="input_single" id="name" name="name" type="text" value="<?php echo $row['name']; ?>" /></div>
		<div id="s_name" class="_span"></div>

	</div>
	<div id="field_content">
		<div id="tittle">Short</div>
		<div id="field"><input class="input_single" id="shortname" name="shortname" type="text" value="<?php echo $row['short_name']; ?>" /></div>
...
function update_new(){   
		...
		var c_password = $('#c_password').attr('value');
