...
$(document).ready(function(){	
	...
	$("#tabs li").click(function() {
		...
		maskPage();
		$(".tab1_content").load("settings/link/link_add.php",function(responseTxt,statusTxt,xhr){
			if(statusTxt=="success")
			  maskPage();
			if(statusTxt=="error")
		...
		$("#tabs li:nth-child(2)").click(function() {
			...
			$(".tab2_content").load("settings/link/link_view.php",function(responseTxt,statusTxt,xhr){
				if(statusTxt=="success")
				 	maskPage();
				if(statusTxt=="error")
				  $(".tab1_content").text("Error: "+xhr.status+": "+xhr.statusText);
