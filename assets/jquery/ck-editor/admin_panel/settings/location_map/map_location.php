...
<link rel="stylesheet" type="text/css" href="settings/location_map/css/<?php echo "map_".$style1; ?>.css"> 
	...
	<?php 
			 $passid = $_SESSION[topleveladmincokieid];
...
<div class="_add_new_sponsor_area">
	...
	<div class="_add_data_header">
		<div class="_sponsor_tittle">List of Paragraph </div>
	</div>
	<div style="clear:both; width:100%; height:1px;"></div>
	<?php 	/*$sql1 = "select * from locationmap where profile_id='".$_SESSION[topleveladmincokieid]."'";
			$rsd1 = mysql_query($sql1);*/

			?>
			<input name="hiden_id" id="hiden_id" type="hidden" value="<?php echo $passid; ?>" />';
  ...
  <div id="" class="_listdata">
  		...
  		<div class="_tittle_common">
			<div class="_bottom tooltip" dir="Click here and change">
				...
				<input id="tittle_common" type="text" name="tittle_common" value="<?php echo $tittle; ?>" class="tittlecommon" />
			</div>
    </div>
  		<div style="clear:both; width:100%; height:1px;"></div>
  		<div class="_detail_common">
			<textarea id="detail_common" class="autoexpand_map" onkeyup="keydown_expand(this);" onchange="keydown_expand(this);" onkeypress="keydown_expand(this);" onkeydown="keydown_expand(this);" name="detail_common"><?php echo $detail; ?></textarea>
		</div>
	  ...
	  <div id="information">Click to the map and select your location by marker. </div>
	  <div class="_buttons">
	    <div id="_save" name="save" class="yui3-button1 tooltip" style="width:100px; margin-left:30px;" dir="Click here to save all your changes" onclick="posting();" title="">
...
function posting(){    
    ...
    if(confirm_user){
                         ...
                         try {   
							...
							tittle_common = $('#tittle_common').val().replace(/&/gi, "^^^");
							detail_common = $('#detail_common').val().replace(/&/gi, "^^^");
							latFld = $('#latFld').val();
							lngFld = $('#lngFld').val();
                     		action = "save_map";
                              ...
                              $.ajax({
                                  ...
                                  data: "tittle_common="+ $.trim(tittle_common)
