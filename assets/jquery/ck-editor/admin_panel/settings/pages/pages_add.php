...
<div id="Addnew">
	...
	<div id="header_text">Add new Page </div>
	
	<div id="clear"></div>

	<div id="field_content">
		<div id="tittle">Name</div>
		<div id="field"><input class="input_single" id="name" name="name" type="text" onkeyup="removeSpaceOnly(this)"  /></div>
