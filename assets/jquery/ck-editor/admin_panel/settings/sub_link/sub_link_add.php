...
<div id="Addnew">
	...
	<div id="header_text">Add new Sub Link </div>
...
//var master_category1 =  $('#master_category1').attr('value');	
	...
	if(valid) {
		...
		$.ajax({
				...
				data: { name: name, otherename: otherename, bi: bi, ind: ind, bn: bn, kr: kr, sp: sp, pr: pr, jp: jp, dt: dt, it: it, chi: chi, main_link: main_link, link_page: link_page,  action: "addnew"  },
