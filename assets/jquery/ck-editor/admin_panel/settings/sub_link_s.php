...
$(document).ready(function(){	
	...
	$("#tabs li").click(function() {
		...
		maskPage();
		$(".tab1_content").load("settings/sub_link/sub_link_add.php",function(responseTxt,statusTxt,xhr){
		...
		$("#tabs li:nth-child(2)").click(function() {
			...
			$(".tab2_content").load("settings/sub_link/sub_link_view.php",function(responseTxt,statusTxt,xhr){
				if(statusTxt=="success")
				 maskPage();
				if(statusTxt=="error")
				  $(".tab1_content").text("Error: "+xhr.status+": "+xhr.statusText);
