...
$(document).ready(function(){	
	...
	$("#tabs li").click(function() {
		...
		$(".tab1_content").load("settings/language/language_add.php",function(responseTxt,statusTxt,xhr){
			if(statusTxt=="success")
		...
		$("#tabs li:nth-child(2)").click(function() {
			...
			$(".tab2_content").load("settings/language/language_view.php",function(responseTxt,statusTxt,xhr){
				if(statusTxt=="success")
				  //alert("External content loaded successfully!");
				if(statusTxt=="error")
				  $(".tab1_content").text("Error: "+xhr.status+": "+xhr.statusText);
