...
<div id="tabs_wrapper">
	<div id="tabs_container">
		<ul id="tabs">
			<li><a href="#tab1">Truncate Now</a></li>
			<li><a href="#tab2">List of Tables</a></li>
...
$(document).ready(function(){	
	...
	$("#tabs li").click(function() {
		...
		maskPage();
		$(".tab1_content").load("settings/truncate/truncate_add.php",function(responseTxt,statusTxt,xhr){
			if(statusTxt=="success")
			  maskPage();
			if(statusTxt=="error")
		...
		$("#tabs li:nth-child(2)").click(function() {
			...
			$(".tab2_content").load("settings/truncate/truncate_view.php",function(responseTxt,statusTxt,xhr){
				if(statusTxt=="success")
				 maskPage();
				if(statusTxt=="error")
				  $(".tab1_content").text("Error: "+xhr.status+": "+xhr.statusText);
