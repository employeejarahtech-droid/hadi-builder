...
$().ready(function(){
	...
	$("#ImageList2").click(function () {
		
		$.ajax({
			url: "imagelist2.php",
			cache: false,
			success : function(){ 	
				$("#InfoClient").load("imagelist2.php"); 
	...
	$("#InstallmentContract").click(function () { 
		...
		$.ajax({
			...
			success : function(){
				...
				$("#InstallmentPay").load("installment_pay.php");				
			}
		});		
    });  
	...
	$("#ProjectExpenditure").click(function () { 	
		$.ajax({
			...
			success : function(){
				AllTabsHide();       			
       			$("#expenditureDiv").show(); 
				$("#pSearch").load("newprojectwissese.php");
	...
	$("#DailyExpenditure").click(function () { 	
		$.ajax({
			url: "session-unset.php",
			cache: false,
			success : function(){
				AllTabsHide();       			
       			$("#DailyexpenditureDiv").show(); 
				//$("#qSearch").load("q.php");
				$("#qMaterial").load("qMaterials.php"); 
				$("#qContractual").load("qLabour.php"); 
				$("#qOtherExpence").load("qOther.php"); 
				$("#qVoucher").load("qVouser_list.php");
	...
	$("#ChangeUser").click(function () {
		...
		// Change user / 
	$("#ProjectWiseImage").click(function () {
