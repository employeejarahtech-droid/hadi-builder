/**
 * ContactMapSectionWidget - A specialized widget for contact information with Map
 * Provides controls for title, address, phone, email, and map
 */
class ContactMapSectionWidget extends WidgetBase {
    getName() {
        return 'contact-map-section';
    }
    ...
    getKeywords() {
        return ['contact', 'map', 'location', 'email', 'phone', 'address'];
    }
    ...
    getDefaultSettings() {
        return {
            ...
            section_subtitle: 'Our Location',
            address: '123 Main Street, City, State 12345',
            phone: '+1 (234) 567-8900',
            email: 'info@example.com',
            map_embed: '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.1422937950147!2d-73.98731968482413!3d40.75889497932681!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25855c6480299%3A0x55194ec5a1ae072e!2sTimes+Square!5e0!3m2!1sen!2sus!4v1510579109238" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>'
        };
    }
    ...
    registerControls() {
        ...
        this.addControl('section_description', {
            type: 'textarea',
            label: 'Description',
            default_value: 'Visit our office or contact us for more information.',
        ...
        this.addControl('map_embed', {
            type: 'textarea',
            label: 'Map Embed Code (Iframe)',
            default_value: '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.1422937950147!2d-73.98731968482413!3d40.75889497932681!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25855c6480299%3A0x55194ec5a1ae072e!2sTimes+Square!5e0!3m2!1sen!2sus!4v1510579109238" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>',
        ...
        this.addControl('map_height', {
            type: 'slider',
            label: 'Map Height',
            default_value: { size: 450, unit: 'px' },
            range: {
                min: 200,
                max: 800,
                step: 10
            ...
            selectors: {
                '{{WRAPPER}} .map-container iframe': 'height: {{SIZE}}{{UNIT}};'
            }
        });
    ...
    render() {
        const title = this.getSetting('section_title', 'Find Us');
        const description = this.getSetting('section_description', 'Visit our office or contact us for more information.');
        ...
        const mapEmbed = this.getSetting('map_embed', '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.1422937950147!2d-73.98731968482413!3d40.75889497932681!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25855c6480299%3A0x55194ec5a1ae072e!2sTimes+Square!5e0!3m2!1sen!2sus!4v1510579109238" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>');
        ...
        const infoPosition = this.getSetting('image_position', 'left');

        // Explicitly get map height to use in inline style as fallback/primary
        const mapHeight = this.getSetting('map_height', { size: 450, unit: 'px' });
        ...
        const uid = 'contact_map_' + Math.floor(Math.random() * 100000);

        // Parse column sizes
        const [leftColSize, rightColSize] = columnLayout.split('-');

        let infoColClass, mapColClass;

        if (infoPosition === 'left') {
            infoColClass = `col-lg-${leftColSize}`;
            mapColClass = `col-lg-${rightColSize}`;
        } else {
            mapColClass = `col-lg-${leftColSize}`;
        ...
        <style>
            ...
            .${uid} .contact-info-single {
                display: flex;
                align-items: center;
                gap: 20px;
            }
                
            .${uid} .contact-info-single .fa {
                font-size: 25px;
            }
            
            .${uid} .map-container iframe {
                width: 100%;
                height: ${mapHeight.size}${mapHeight.unit};
                border: 0;
                border-radius: 10px;
    ...
    `;
        ...
        return `
    ${style}
    <section class="contact-map-1 ${uid}">
      <div class="container">
        ...
        <div class="comingsoon-body-item block-item">
          <div class="contact-wrap mt-5">
            <div class="row align-items-center" style="flex-direction: ${flexDirection}; --bs-gutter-x: ${gap.size}${gap.unit};">
                ${infoPosition === 'left' ? infoColumn + mapColumn : mapColumn + infoColumn}
            </div>
          </div>
        </div>
      </div>
...
window.elementorWidgetManager.registerWidget(ContactMapSectionWidget);
