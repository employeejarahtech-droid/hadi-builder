class LoginFormWidget extends WidgetBase {
    getName() {
        return 'login_form';
    }
    getTitle() {
    ...
    render() {
        const title = this.getSetting('title', 'Login');
        ...
        const contentHtml = `<div style="border: 1px solid #e5e7eb; border-radius: 12px; padding: 30px; max-width: 400px; margin: 0 auto;"><h3 style="font-size: 24px; font-weight: 700; margin: 0 0 20px 0; text-align: center;">${this.escapeHtml(title)}</h3><form><div style="margin-bottom: 15px;"><label style="display: block; font-size: 14px; font-weight: 600; margin-bottom: 5px;">Email</label><input type="email" placeholder="your@email.com" style="width: 100%; padding: 12px 15px; border: 1px solid #e5e7eb; border-radius: 6px; font-size: 14px;"></div><div style="margin-bottom: 15px;"><label style="display: block; font-size: 14px; font-weight: 600; margin-bottom: 5px;">Password</label><input type="password" placeholder="••••••••" style="width: 100%; padding: 12px 15px; border: 1px solid #e5e7eb; border-radius: 6px; font-size: 14px;"></div><div style="margin-bottom: 20px;"><label style="display: flex; align-items: center; gap: 8px; font-size: 14px; cursor: pointer;"><input type="checkbox" style="width: 16px; height: 16px;"><span>Remember me</span></label></div><button type="submit" style="width: 100%; background: ${buttonColor}; color: white; border: none; padding: 12px; border-radius: 6px; font-size: 14px; font-weight: 600; cursor: pointer;">Login</button><div style="text-align: center; margin-top: 15px;"><a href="#" style="color: ${buttonColor}; font-size: 14px; text-decoration: none;">Forgot password?</a></div></form></div>`;
        let wrapperClasses = ['login-form-widget'];
...
window.elementorWidgetManager.registerWidget(LoginFormWidget);
