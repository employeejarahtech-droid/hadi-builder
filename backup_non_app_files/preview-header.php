<?php
// preview-header.php - Preview header with sample content

require_once __DIR__ . '/includes/db.php';

// Get header ID from URL
$headerId = $_GET['header_id'] ?? null;
...
<head>
    ...
    <title>Header Preview - <?php echo htmlspecialchars($header['title']); ?> - <?php echo htmlspecialchars($appName); ?></title>
...
<body>
    ...
    <div class="preview-header">
        <strong>Header Preview</strong> - Viewing "<?php echo htmlspecialchars($header['title']); ?>" header
    </div>
    ...
    <div class="preview-content">
        <div>
            ...
            <p>This is sample content to demonstrate how your header will appear on a real page.
            The header above contains all the elements you've configured in the header builder.</p>
        </div>
    </div>

    <!-- Sample Footer -->
    <div class="preview-footer">
        <p>© 2024 <?php echo htmlspecialchars($appName); ?>. This is a sample footer area.</p>
    </div>
    ...
    <script>
        ...
        window.SITE_DATA = {
            ...
            footer: []  // No footer for header preview
        };

        // Initialize renderer to show header
        $(document).ready(function() {
            // Load PublicRenderer
            const script = document.createElement('script');
            script.src = '<?php echo $root; ?>/assets/core/PublicRenderer.js';
            script.onload = function() {
                // Renderer will automatically load and render the header
                console.log('Header preview loaded');
            };
